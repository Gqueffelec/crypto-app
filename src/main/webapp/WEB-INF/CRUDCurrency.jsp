		...
		<div class="row align-items-center justify-content-around h-25">
			<div class="col-xs align-self-center ">
				<button type="button" class="btn btn-info custom"
					data-toggle="modal" data-target="#add">Add a new
					CryptoCurrency</button>
			</div>
			<div class="col-xs align-self-center">
				<button type="button" class="btn btn-info custom"
					data-toggle="modal" data-target="#rmv">Remove a
					CryptoCurrency</button>
			</div>
			<div class="col-xs align-self-center">
				<button type="button" class="btn btn-info custom"
					data-toggle="modal" data-target="#upd" id="updatebutton">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<label for="name">Name</label> <input type="text" name="name"
					class="name"> <label for="label">Label</label> <input
					type="text" name="label" class="label"> <label
					for="actualprice">Actual Price</label> <input type="number"
					name="actualprice" class="actualprice">
			</div>
...
<div class="modal fade" id="rmv" tabindex="-1" role="dialog"
	aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Remove a
					CryptoCurrency</h5>
				<button type="button" class="close" data-dismiss="modal"
					aria-label="Close">
					<span aria-hidden="true">&times;</span>
			...
			<div class="modal-body">
				<label for="id">Id</label> <select name="id" class="id">
					<c:forEach items="${list}" var="crypto">
...
<div class="modal fade" id="upd" tabindex="-1" role="dialog"
	aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Update a
					CryptoCurrency</h5>
				<button type="button" class="close" data-dismiss="modal"
					aria-label="Close">
					<span aria-hidden="true">&times;</span>
